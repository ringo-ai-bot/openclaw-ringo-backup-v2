---
name: create-branch
description: Create a git branch following Erudifi naming conventions. Use when asked to "create a branch", "new branch", "start a branch", "make a branch", "switch to a new branch", or when starting new work on the default branch.
argument-hint: '[optional description of the work]'
---

# Create Branch

Create a git branch following Erudifi naming conventions.
...
3. Generate `<type>/<short-description>`.
   ...
   When changes are related to Linear ticket, then use the Linear Issue ID as description (e.g. feat/oi-1880, fix/lend-2550)
